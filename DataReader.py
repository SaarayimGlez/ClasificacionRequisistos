...
#Arrays of labels
c_labels = np.ones(4, dtype = np.int8) #Codiv
n_labels = np.zeros(4, dtype = np.int8) #Normal
p_labels = np.full((4,), 2) #Pneumonia

#Images path
c_root = 'C:/Users/saara/Desktop/MIA 2/DeepGA-main (1)/DeepGA-main/Images/COVID-19/covidp'
n_root = 'C:/Users/saara/Desktop/MIA 2/DeepGA-main (1)/DeepGA-main/Images/Normal/normalp'
p_root = 'C:/Users/saara/Desktop/MIA 2/DeepGA-main (1)/DeepGA-main/Images/Pneumonia/pneumoniap'
